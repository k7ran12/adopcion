...
@section('content')
   <Section class="minsection">
    ...
    <section class="pet-care">
        ...
        <div class="d-img1">
            <img src="{{ @Vite::asset('resources/images/dog-left.png') }}" alt="">
        </div>
        <h6>Service</h6>
        <h2>DogMilo Pet Care Services<br> For Your Best Friends.</h2>
        <div class="container">
            <div class="row">

                <div class="col-md-22 pet-dog">
                    <div class="pet-service">
                        <div class="pet-img">
                            <img src="{{ @Vite::asset('resources/images/images/d-1.png') }}" alt="">
                        </div>
                        <h4>Pet Sitting</h4>
                        <p>The readable content of a page when looking at its layout.</p>
                        <div class="right-arrow">
                            <a href="services-details.html"><img src="{{ @Vite::asset('resources/images/images/right.png') }}" alt=""></a>
                        </div>
                ...
                <div class="col-md-22 pet-dog">
                    <div class="pet-service">
                        <div class="pet-img">
                            <img src="{{ @Vite::asset('resources/images/images/d-2.png') }}" alt="">
                        </div>
                        <h4>Puppy Sitting</h4>
                        <p>The readable content of a page when looking at its layout.</p>
                        <div class="right-arrow">
                ...
                <div class="col-md-22 pet-dog">
                    <div class="pet-service">
                        <div class="pet-img">
                            <img src="{{ @Vite::asset('resources/images/images/d-3.png') }}" alt="">
                        </div>
                        <h4>Dog Walking</h4>
                        <p>The readable content of a page when looking at its layout.</p>
                        <div class="right-arrow">
                            <a href="services-details.html"><img src="{{ @Vite::asset('resources/images/right.png') }}" alt=""></a>
                        </div>
                ...
                <div class="col-md-22 pet-dog">
                    <div class="pet-service">
                        <div class="pet-img">
                            <img src="{{ @Vite::asset('resources/images/d-4.png') }}" alt="">
                        </div>
                        <h4>Night Care</h4>
                        <p>The readable content of a page when looking at its layout.</p>
                        <div class="right-arrow">
                ...
                <div class="col-md-22 pet-dog">
                    <div class="pet-service">
                        <div class="pet-img">
                            <img src="{{ @Vite::asset('resources/images/d-5.png') }}" alt="">
                        </div>
                        <h4>Pet Sitting</h4>
                        <p>The readable content of a page when looking at its layout.</p>
                        <div class="right-arrow">
